      ...
      K
       ...
       for ind_n = 1:length(n_grid),
            ...
            display('n')
             ...
             for iter = 1:NMC,
                    file_A = ['/Users/oscar/Desktop/community detection/simulations/A_ind3n' num2str(n) 'K' num2str(K) 'iter' num2str(iter) '.txt'];     
                    file_P = ['/Users/oscar/Desktop/community detection/simulations/P_ind3n' num2str(n) 'K' num2str(K) 'iter' num2str(iter) '.txt'];     
...
dlmwrite('ex3_average_MSE_ns.txt',average_MSE_ns);
dlmwrite('ex3_average_MSE_sas.txt',average_MSE_sas);
dlmwrite('ex3_average_MSE_usvt.txt',average_MSE_usvt);


dlmwrite('ex3_MSE_ns.txt',MSE_ns);
dlmwrite('ex3_MSE_sas.txt',MSE_sas);
dlmwrite('ex3_MSE_usvt.txt',MSE_usvt);