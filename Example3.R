...
#setwd("C:/Users/user/Desktop/community_detection")
#output_directory = "C:/Users/user/Desktop/community_detection/simulations/"
...
a  =  list()
a[[1]] =  c(1/6,2/6,3/6,4/6,5/6,1,7/6,8/6,9/6,10/6,11/6)    #sort(runif(K_grid[1]))
...
{ 
  ...
  for(ind_n in 1:length(n_grid))
  {
    ...
    for(iter  in 1:NMC)
    {
      ...
      ######################
      A_name  =  paste("A_ind3",'n',toString(n),'K',toString(K),"iter",iter,sep='')
      A_name = paste(output_directory,A_name,".txt",sep="")
      write.table(A,A_name,col.names = FALSE,row.names = FALSE)
      
      P_name  =  paste("P_ind3",'n',toString(n),'K',toString(K),"iter",iter,sep='')
...
# 
# 
# name1  =  paste("average_MSE_1_ind3",'n',toString(n),'K',toString(K),sep='')
# name1 = paste(output_directory,name1,".txt",sep="")
# write.table(average_MSE_1,name1,col.names = FALSE,row.names = FALSE)
# 
# 
# name2  =  paste("average_MSE_2_ind3",'n',toString(n),'K',toString(K),sep='')
# name2 = paste(output_directory,name2,".txt",sep="")
# write.table(average_MSE_2,name2,col.names = FALSE,row.names = FALSE)
# 
# name3  =  paste("average_MSE_3_ind3",'n',toString(n),'K',toString(K),sep='')
# name3 = paste(output_directory,name3,".txt",sep="")
# write.table(average_MSE_3,name3,col.names = FALSE,row.names = FALSE)





name1  =  paste("ex3_average_MSE_1_ind1",'n',toString(n),'K',toString(K),sep='')
name1 = paste(output_directory,name1,".txt",sep="")
write.table(average_MSE_1,name1,col.names = FALSE,row.names = FALSE)

name1  =  paste("ex3_MSE_1_ind1",'n',toString(n),'K',toString(K),sep='')
name1 = paste(output_directory,name1,".txt",sep="")
write.table(drop(MSE_1),name1,col.names = FALSE,row.names = FALSE)


name2  =  paste("ex3_average_MSE_2_ind1",'n',toString(n),'K',toString(K),sep='')
name2 = paste(output_directory,name2,".txt",sep="")
write.table(average_MSE_2,name2,col.names = FALSE,row.names = FALSE)

name2  =  paste("ex3_MSE_2_ind1",'n',toString(n),'K',toString(K),sep='')
name2 = paste(output_directory,name2,".txt",sep="")
write.table(drop(MSE_2),name2,col.names = FALSE,row.names = FALSE)

name3  =  paste("ex3_MSE_3_ind1",'n',toString(n),'K',toString(K),sep='')
name3 = paste(output_directory,name3,".txt",sep="")
